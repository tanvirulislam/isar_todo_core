...
const RoutineSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'categoryName': LinkSchema(
      id: 7903049007395709806,
      name: r'categoryName',
      target: r'Category',
      single: true,
    )
...
void _routineAttach(IsarCollection<dynamic> col, Id id, Routine object) {
  object.id = id;
  object.categoryName
      .attach(col, col.isar.collection<Category>(), r'categoryName', id);
}
...
extension RoutineQueryLinks
    on QueryBuilder<Routine, Routine, QFilterCondition> {
  QueryBuilder<Routine, Routine, QAfterFilterCondition> categoryName(
      FilterQuery<Category> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'categoryName');
    });
  }

  QueryBuilder<Routine, Routine, QAfterFilterCondition> categoryNameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'categoryName', 0, true, 0, true);
    });
  }
}
